...
char watermark_filename[WATERMARK_SOURCE_NUM][64] = {
	...
	"V:/image/logos.png.BGRA8888.ez"  // "V:/image/wm_logo.png.BGRA8888.ez"
};
...
int watermark_logo(void *rec, int index)
{
	...
	watermark.start_x_pos = 48;
	watermark.start_y_pos = 32;
	// if(rec_resolution==0){  //720 
	// watermark.start_y_pos = 720-64*3;//20
    // }else{
    //   watermark.start_y_pos = 1080-64*3;//20
	// }	
