/*
 * thumb_video.h - thumb video head file
 *
...
#ifndef __THUMB_VIDEO_H__
#define __THUMB_VIDEO_H__
...
typedef struct {
	...
	lb_uint32 w : 11;             /* Width of the video map */
	lb_uint32 h : 11;             /* Height of the video map */
} thumb_vid_header_t;

typedef struct {
	thumb_vid_header_t header;
	lb_uint32 data_size;
	const lb_uint8 *data;
} thumb_vid_dsc_t;
