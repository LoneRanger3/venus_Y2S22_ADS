...
int car_recorder_draw_polygon(unsigned char *buff, line_point *points,
	uint32_t line_w, uint32_t line_color, uint8_t en_fill, uint32_t fill_color);
int blk_draw_str(uint8_t *buff, lb_rect_t area, uint8_t rotate,
	uint32_t meters, uint32_t color);
