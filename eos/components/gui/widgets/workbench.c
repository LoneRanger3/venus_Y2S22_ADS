...
{
	rtgui_container_t *container = NULL;
	rtgui_widget_t* child = NULL;

	container = RTGUI_CONTAINER(workbench);
	child = RTGUI_WIDGET(view);
	rtgui_container_add_child(container, child);
