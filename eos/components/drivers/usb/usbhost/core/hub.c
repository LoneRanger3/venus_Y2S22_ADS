...
static rt_err_t rt_usbh_hub_port_change(uhub_t hub)
{
	...
	/* fix speed: PSPD field in portsc reg is valid only after reset the port */
	device->speed = hcd_get_device_speed();
#endif
