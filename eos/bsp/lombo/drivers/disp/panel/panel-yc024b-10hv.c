/*
 * panel-yc024b-10hv.c - Panel manufacturer module driver code for LomboTech
 *
...
#define DBG_SECTION_NAME	"YC024B_10HV"
 ...
 */
#define DISP_PANEL_MODULE	"panel_yc024b"
...
#define DCLK		(18562500) /* 297/8 = 37.125MHz  */
...
static u8 init_code[] = {
	...
	DCS_MDELAY_FLAG, 2, 3, 0xC0,
	0x3B,/* 480 */
	0x00,

	DCS_MDELAY_FLAG, 2, 3, 0xC1,
	0x10,
	0x02,

	DCS_MDELAY_FLAG, 2, 3, 0xC2,
	0x01,
	0x09,

	DCS_MDELAY_FLAG, 2, 2, 0xCC,
	0x10,


	DCS_MDELAY_FLAG, 2, 17, 0xB0,
	0x80,
	0xD2,
	0x5A,
	0x11,
	...
	DCS_MDELAY_FLAG, 2, 2, 0xB0,/* VOP */
	0x6D,/* 4.9V */

	DCS_MDELAY_FLAG, 2, 2, 0xB1,/* VCOM */
	0x2A,

	DCS_MDELAY_FLAG, 2, 2, 0xB2,/* VGH */
	0x81,/* 12V */

	DCS_MDELAY_FLAG, 2, 2, 0xB3,
	0x80,

	DCS_MDELAY_FLAG, 2, 2, 0xB5,/* VGL */
	0x4E,/* -12.2V */

	DCS_MDELAY_FLAG, 2, 2, 0xB7,
	0x85,

	DCS_MDELAY_FLAG, 2, 2, 0xB8,
	0x20,

	DCS_MDELAY_FLAG, 2, 2, 0xC1,
	0x78,

	DCS_MDELAY_FLAG, 2, 2, 0xC2,
	0x78,

	DCS_MDELAY_FLAG, 2, 2, 0xD0,
	0x88,


	DCS_MDELAY_FLAG, 100, 4, 0xE0,
	0x00,
	0x00,
	0x02,

	DCS_MDELAY_FLAG, 2, 12, 0xE1,
	0x05,
	0xA0,
	0x07,
	0xA0,
	...
	DCS_MDELAY_FLAG, 2, 5, 0xE3,
	0x00,
	0x00,
	0x11,
	0x11,

	DCS_MDELAY_FLAG, 2, 3, 0xE4,
	0x44,
	0x44,

	DCS_MDELAY_FLAG, 2, 17, 0xE5,
	0x0D,
	0xF1,
	0xA0,
	0xA0,
	...
	DCS_MDELAY_FLAG, 2, 5, 0xE6,
	0x00,
	0x00,
	0x11,
	0x11,

	DCS_MDELAY_FLAG, 2, 3, 0xE7,
	0x44,
	0x44,

	DCS_MDELAY_FLAG, 2, 17, 0xE8,
	0x0C,
	0xF0,
	0xA0,
	0xA0,
	...
	DCS_MDELAY_FLAG, 2, 2, 0x3A,/* 50---RGB565,60---RGB666,70-----RGB888 */
	0x50,

	DCS_MDELAY_FLAG, 2, 1, 0x11,



	DCS_MDELAY_FLAG, 120, 1, 0x29,

	DCS_MDELAY_FLAG, 120, 2, 0x36,
	0x10,/* 00 --FW;10 ----BW */
};

/* vo dev config */
static void yc024b_10hv_dev_config(vo_device_t *vo_dev)
{
...
/* Power up */
static void yc024b_10hv_dev_init(vo_device_t *vo_dev)
{
...
/* Power down */
static void yc024b_10hv_dev_exit(vo_device_t *vo_dev)
{
	/* back light pwm exit */
...
static int yc024b_10hv_dev_set_backlight_state(bool state)
{
	int ret;
...
static int yc024b_10hv_dev_set_backlight_value(u32 value)
{
	return 0;/* panel_set_backlight_value(DISP_PANEL_MODULE, value); */
}

static int rt_yc024b_10hv_panel_init(void)
{
	/* this memory not need to free  */
	disp_panel_ctl_t *pctl = rt_malloc(sizeof(disp_panel_ctl_t));

	pctl->ops.dev_config = yc024b_10hv_dev_config;
	pctl->ops.dev_init = yc024b_10hv_dev_init;
	pctl->ops.dev_exit = yc024b_10hv_dev_exit;
	pctl->ops.dev_set_backlight_state = yc024b_10hv_dev_set_backlight_state;
	pctl->ops.dev_set_backlight_value = yc024b_10hv_dev_set_backlight_value;
...
INIT_APP_EXPORT(rt_yc024b_10hv_panel_init);
