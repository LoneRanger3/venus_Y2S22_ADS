/*
 * panel-ZT0936BOE.c - Panel manufacturer module driver code for LomboTech
 *
...
#define DBG_SECTION_NAME	"ZT0936BOE"
 ...
 */
#define DISP_PANEL_MODULE	"panel_ZT0936BOE"
...
#define DCLK		(47125000) /* 297/8 = 37.125MHz  */
...
static u8 init_code[] = {
	...
	3, 0xF0, 0x5A, 0x59,
	3, 0xF1, 0xA5, 0xA6,
	23, 0xB4, 0x00, 0x04, 0x05, 0x00, 0x1E, 0x1F, 0x01, 0x10, 0x11, 0x12, 0x13, 0x0C,
	0x0D, 0x0E, 0x0F, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03,
	16, 0xB0, 0xC6, 0xBB, 0xBB, 0xBB, 0x33, 0x33, 0x33, 0x33, 0x24, 0x00, 0x00, 0x9C,
	0x00, 0x00, 0x80,
	12, 0xB1, 0x53, 0xA0, 0x00, 0x85, 0x04, 0x00, 0x00, 0x7C, 0x00, 0x00, 0x5F,
	11, 0xB2, 0x07, 0x09, 0x08, 0x8B, 0x08, 0x00, 0x22, 0x00, 0x44, 0xD9,
	3, 0xB6, 0x4a, 0x4a,
	19, 0xB7, 0x01, 0x01, 0x09, 0x0D, 0x11, 0x19, 0x1D, 0x15, 0x00, 0x25, 0x21, 0x00,
	0x00, 0x00, 0x00, 0x02, 0xF7, 0x38,
	5, 0xB8, 0xB8, 0x52, 0x02, 0xCC,
	3, 0xBA, 0x27, 0xD3,
	8, 0xBD, 0x43, 0x0E, 0x0E, 0x4B, 0x4B, 0x32, 0x14,
	9, 0xC1, 0x00, 0x0F, 0x0E, 0x01, 0x00, 0x36, 0x3A, 0x08,
	3, 0xC2, 0x22, 0x80,
	3, 0xC3, 0x22, 0x31,
	9, 0xC6, 0x00, 0x00, 0xFF, 0x00, 0x00, 0xFF, 0x00, 0x00,
/*
	39, 0xC8, 0x7C, 0x68, 0x59, 0x4D, 0x4A, 0x3B, 0x40, 0x29, 0x41, 0x3F, 0x3E, 0x5B,
	0x4A, 0x53, 0x45, 0x44, 0x37, 0x24, 0x06, 0x7C, 0x68, 0x59, 0x4D, 0x4A, 0x3B,
	0x40, 0x29, 0x41, 0x3F, 0x3E, 0x5B, 0x4A, 0x53, 0x46, 0x44, 0x37, 0x24, 0x06,
*/
	39, 0xC8, 0x7C, 0x69, 0x5C, 0x50, 0x4E, 0x40, 0x45, 0x2F, 0x47, 0x45, 0x45, 0x62,
	0x52, 0x5C, 0x4E, 0x4D, 0x3F, 0x2D, 0x06, 0x7C, 0x69, 0x5C, 0x50, 0x4E, 0x40,
	0x45, 0x2F, 0x47, 0x45, 0x45, 0x62, 0x52, 0x5C, 0x4E, 0x4D, 0x3F, 0x2D, 0x06,
/*
	39, 0xC8, 0x7C, 0x63, 0x53, 0x45, 0x41, 0x31, 0x34, 0x1D, 0x34, 0x32, 0x32, 0x4E,
	0x3B, 0x43, 0x34, 0x31, 0x26, 0x15, 0x06, 0x7C, 0x63, 0x52, 0x45, 0x41, 0x31,
	0x34, 0x1D, 0x34, 0x32, 0x32, 0x4E, 0x3B, 0x43, 0x34, 0x31, 0x26, 0x15, 0x06,

	39, 0xC8, 0x7C, 0x66, 0x56, 0x49, 0x46, 0x37, 0x3a, 0x23, 0x3B, 0x38, 0x38, 0x55,
	0x43, 0x4C, 0x40, 0x3C, 0x2F, 0x1C, 0x06, 0x7C, 0x65, 0x56, 0x4a, 0x46, 0x37,
	0x3a, 0x23, 0x3a, 0x38, 0x38, 0x55, 0x43, 0x4C, 0x40, 0x3C, 0x2F, 0x1C, 0x06,
*/
	4, 0xD0, 0x07, 0xFF, 0xFF,
	5, 0xD2, 0x63, 0x0B, 0x08, 0x88,
	7, 0xD4, 0x00, 0x00, 0x00, 0x32, 0x04, 0x51,
	3, 0xF1, 0x5A, 0x59,
	3, 0xF0, 0xA5, 0xA6,
...
/* vo dev config */
static void ZT0936BOE_dev_config(vo_device_t *vo_dev)
{
...
/* Power up */
static void ZT0936BOE_dev_init(vo_device_t *vo_dev)
{
...
/* Power down */
static void ZT0936BOE_dev_exit(vo_device_t *vo_dev)
{
	/* back light pwm exit */
...
static int ZT0936BOE_dev_set_backlight_state(bool state)
{
	int ret;
...
static int ZT0936BOE_dev_set_backlight_value(u32 value)
{
	return panel_set_backlight_value(DISP_PANEL_MODULE, value);
}

static int rt_ZT0936BOE_panel_init(void)
{
	/* this memory not need to free  */
	disp_panel_ctl_t *pctl = rt_malloc(sizeof(disp_panel_ctl_t));

	pctl->ops.dev_config = ZT0936BOE_dev_config;
	pctl->ops.dev_init = ZT0936BOE_dev_init;
	pctl->ops.dev_exit = ZT0936BOE_dev_exit;
	pctl->ops.dev_set_backlight_state = ZT0936BOE_dev_set_backlight_state;
	pctl->ops.dev_set_backlight_value = ZT0936BOE_dev_set_backlight_value;
...
INIT_APP_EXPORT(rt_ZT0936BOE_panel_init);
