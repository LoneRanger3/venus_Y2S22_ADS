 ...
 */
#define DISP_PANEL_MODULE	"panel_wks7002"
...
#define DCLK		(66000000) /* 66MHz about 73 frames,  66000000 / (HT * VT)*/
/*
...
/* vo dev config */
static void ek79003a_wks70002_dev_config(vo_device_t *vo_dev)
{
...
/* Power up */
static void ek79003a_wks70002_dev_init(vo_device_t *vo_dev)
{
#ifndef ARCH_LOMBO_N7V1_EVB
	/* reset init */
...
/* Power down */
static void ek79003a_wks70002_dev_exit(vo_device_t *vo_dev)
{
	/* back light exit */
...
static int ek79003a_wks70002_dev_set_backlight_state(bool state)
{
	int ret;
...
static int rt_ek79003a_wks70002_panel_init(void)
{
	/* this memory not need to free  */
	disp_panel_ctl_t *pctl = rt_malloc(sizeof(disp_panel_ctl_t));

	pctl->ops.dev_config = ek79003a_wks70002_dev_config;
	pctl->ops.dev_init = ek79003a_wks70002_dev_init;
	pctl->ops.dev_exit = ek79003a_wks70002_dev_exit;
	pctl->ops.dev_set_backlight_state = ek79003a_wks70002_dev_set_backlight_state;
...
INIT_APP_EXPORT(rt_ek79003a_wks70002_panel_init);
