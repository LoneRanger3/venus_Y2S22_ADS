/*
 * panel-wtl096602G02-24.c - Panel manufacturer module driver code for LomboTech
 *
...
#define DBG_SECTION_NAME	"WT1096601G02_24"
 ...
 */
#define DISP_PANEL_MODULE	"panel_wtl096602"
...
/* vo dev config */
static void wtl096601G02_24_dev_config(vo_device_t *vo_dev)
{
...
/* Power up */
static void wtl096601G02_24_dev_init(vo_device_t *vo_dev)
{
	...
	/* dsi dcs init */
	mipi_dsi_dcs_write_array(dsi_index, 0,
		init_code, ARRAY_CNT(init_code), DCS_MDELAY_FLAG);
...
/* Power down */
static void wtl096601G02_24_dev_exit(vo_device_t *vo_dev)
{
	/* back light pwm exit */
...
static int wtl096601G02_24_dev_set_backlight_state(bool state)
{
	int ret;
...
static int wtl096601G02_24_dev_set_backlight_value(u32 value)
{
	return panel_set_backlight_value(DISP_PANEL_MODULE, value);
}

static int rt_wtl096601G02_24_panel_init(void)
{
	/* this memory not need to free  */
	disp_panel_ctl_t *pctl = rt_malloc(sizeof(disp_panel_ctl_t));

	rt_kprintf("rt_wtl096601G02_24_panel_init\n");
	rt_kprintf("rt_wtl096601G02_24_panel_init\n");

	pctl->ops.dev_config = wtl096601G02_24_dev_config;
	pctl->ops.dev_init = wtl096601G02_24_dev_init;
	pctl->ops.dev_exit = wtl096601G02_24_dev_exit;
	pctl->ops.dev_set_backlight_state = wtl096601G02_24_dev_set_backlight_state;
	pctl->ops.dev_set_backlight_value = wtl096601G02_24_dev_set_backlight_value;
...
INIT_APP_EXPORT(rt_wtl096601G02_24_panel_init);
