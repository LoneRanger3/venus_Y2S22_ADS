...
#define DBG_SECTION_NAME	"WT1096601G01_24_IVO"
 ...
 */
#define DISP_PANEL_MODULE	"panel_wtl096601"
...
#define DCLK		(37125000) /* 297/8 = 37.125MHz  */
...
static u8 init_code[] = {
	...
	3,0xF0,0x5A,0x59,
	3,0xF1,0xA5,0xA6,
	23,0xB4,0x00,0x04,0x05,0x00,0x1E,0x1F,0x01,0x10,0x11,0x12,0x13,0x0C,0x0D,0x0E,0x0F,0x03,0x03,0x03,0x03,0x03,0x03,0x03,
	16,0xB0,0xC6,0xBB,0xBB,0xBB,0x33,0x33,0x33,0x33,0x24,0x00,0x00,0x9C,0x00,0x00,0x80,
	12,0xB1,0x53,0xA0,0x00,0x85,0x04,0x00,0x00,0x7C,0x00,0x00,0x5F,
	11,0xB2,0x07,0x09,0x08,0x8B,0x08,0x00,0x22,0x00,0x44,0xD9,
	3,0xB6,0x43,0x43,
	19,0xB7,0x01,0x01,0x09,0x0D,0x11,0x19,0x1D,0x15,0x00,0x25,0x21,0x00,0x00,0x00,0x00,0x02,0xF7,0x38,
	...
	39,0xC8,0x7C,0x65,0x55,0x48,0x44,0x34,0x38,0x22,0x3a,0x38,0x38,0x55,0x43,0x4C,0x40,0x3C,0x2F,0x1C,0x06,0x7C,0x65,0x55,0x48,0x44,0x34,0x38,0x22,0x3a,0x38,0x38,0x55,0x43,0x4C,0x40,0x3C,0x2F,0x1C,0x06,//G2.2
	4,0xD0,0x07,0xFF,0xFF,
	5,0xD2,0x63,0x0B,0x08,0x88,    // 0x63 4lane;0x62 3lane;0x61  2lane
...
/* vo dev config */
static void wtl096601G01_24_ivo_dev_config(vo_device_t *vo_dev)
{
...
/* Power up */
static void wtl096601G01_24_ivo_dev_init(vo_device_t *vo_dev)
{
...
/* Power down */
static void wtl096601G01_24_ivo_dev_exit(vo_device_t *vo_dev)
{
	/* back light pwm exit */
...
static int wtl096601G01_24_ivo_dev_set_backlight_state(bool state)
{
	int ret;
...
static int wtl096601G01_24_ivo_dev_set_backlight_value(u32 value)
{
	return panel_set_backlight_value(DISP_PANEL_MODULE, value);
}

static int rt_wtl096601G01_24_ivo_panel_init(void)
{
	/* this memory not need to free  */
	disp_panel_ctl_t *pctl = rt_malloc(sizeof(disp_panel_ctl_t));

	pctl->ops.dev_config = wtl096601G01_24_ivo_dev_config;
	pctl->ops.dev_init = wtl096601G01_24_ivo_dev_init;
	pctl->ops.dev_exit = wtl096601G01_24_ivo_dev_exit;
	pctl->ops.dev_set_backlight_state = wtl096601G01_24_ivo_dev_set_backlight_state;
	pctl->ops.dev_set_backlight_value = wtl096601G01_24_ivo_dev_set_backlight_value;
...
INIT_APP_EXPORT(rt_wtl096601G01_24_ivo_panel_init);
