 ...
 */
#define DISP_PANEL_MODULE	"panel_tm070jdhg"
...
/* vo dev config */
static void tianma_tm070jdhg30_dev_config(vo_device_t *vo_dev)
{
...
/* Power up */
static void tianma_tm070jdhg30_dev_init(vo_device_t *vo_dev)
{
	/* reset init */
...
/* Power down */
static void tianma_tm070jdhg30_dev_exit(vo_device_t *vo_dev)
{
	/* back light exit */
...
static int tianma_tm070jdhg30_dev_set_backlight_state(bool state)
{
	int ret;
...
static int rt_tianma_tm070jdhg30_panel_init(void)
{
	/* this memory not need to free  */
	disp_panel_ctl_t *pctl = rt_malloc(sizeof(disp_panel_ctl_t));

	pctl->ops.dev_config = tianma_tm070jdhg30_dev_config;
	pctl->ops.dev_init = tianma_tm070jdhg30_dev_init;
	pctl->ops.dev_exit = tianma_tm070jdhg30_dev_exit;
	pctl->ops.dev_set_backlight_state = tianma_tm070jdhg30_dev_set_backlight_state;
...
INIT_APP_EXPORT(rt_tianma_tm070jdhg30_panel_init);
